...
Settings::Settings(int argc, char * argv[])
{
	...
	args::ValueFlag<int> start_agents_number(optional, "start-n", "Starting number of agents", { "start-n" }, 1024 * 32);
	args::ValueFlag<int> maximum_agents_number(optional, "max-n", "Maximum number of agents", { "max-n" }, 1024 * 32 * 2);
	...
	args::Flag debug(optional, "debug", "Show debug information", { "debug" });
